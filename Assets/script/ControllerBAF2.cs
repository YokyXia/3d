...
public class ControllerBAF2 : MonoBehaviour
{
        ...
        if (flag && isMoving)
        {
         //   Debug.Log("true");
            ...
            if (distance <= 0.1f)
            {
                // 停止移动物体
                isMoving = false;
                hongse.SetActive(true);
            //    aaaaaaaa.transform.position = new Vector3(16.5883064f, 7.58812809f, 31.5492077f);
            }
            else
            {
                // 移动物体
